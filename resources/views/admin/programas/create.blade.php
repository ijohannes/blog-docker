...
@include('flash::message')
    {!! Form::open(['route' => 'programas.store', 'method' => 'POST', 'enctype' => 'multipart/form-data','files' => true]) !!}
        <div class="form-group col-md-6">
            {!! Form::label('titulo', 'Titulo del programa') !!} 
            {!! Form::text('titulo', null, ['class' => 'form-control', 'placeholder' => 'Titulo del programa...' , 'required']) !!}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            {!! Form::submit('Agregar programa', ['class' => 'btn btn-primary']) !!}
        </div>
    {!! Form::close() !!}
